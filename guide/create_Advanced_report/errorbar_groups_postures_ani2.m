function [bar_xtick,hb,he]=errorbar_groups_postures_ani2(bar_input,errorbar_input,varargin)
%
...
bar_width=0.9;
errorbar_width=0.75;
bar_colors=[1 0 0;0 0 1;0 1 1; 0 1 0; 0 0 0];
%bar_colors=distinguishable_colors_ani(N_grps,bg); % get some distinguishable colors for the bars!
