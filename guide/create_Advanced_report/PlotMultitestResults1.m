function PlotMultitestResults1(PA_Baseline,Gait_Baseline,PA_FW1,Gait_FW1,PA_FW2,Gait_FW2,PA_FW3,Gait_FW3)

style='Titre 1';  %not used
...
path_Gait_Baseline=analysis_struct_Gait_Baseline.path_destination;
...
analysis_struct_PA_FW1=load(['./Analysis_database/',PA_FW1,'.mat']);
path_PA_FW1=analysis_struct_PA_FW1.path_destination;

load([path_PA_FW1,'/PercentBarcodeStates']);
load([path_PA_FW1,'/PercentPostures']);
load([path_PA_FW1,'/DurationPeriodPostures']);

analysis_struct_Gait_FW1=load(['./Analysis_database/',Gait_FW1,'.mat']);
path_Gait_FW1=analysis_struct_Gait_FW1.path_destination;
load([path_Gait_FW1,'/GaitParamsSelectedBySpeed']);
load([path_Gait_FW1,'/SymetryIndex']);
load([path_Gait_FW1,'/walking_params_new']);
load metrics_perf 
...
analysis_struct_PA_FW2=load(['./Analysis_database/',PA_FW2,'.mat']);
path_PA_FW2=analysis_struct_PA_FW2.path_destination;

load([path_PA_FW2,'/PercentBarcodeStates']);
load([path_PA_FW2,'/PercentPostures']);
load([path_PA_FW2,'/DurationPeriodPostures']);

analysis_struct_Gait_FW2=load(['./Analysis_database/',Gait_FW2,'.mat']);
path_Gait_FW2=analysis_struct_Gait_FW2.path_destination;
load([path_Gait_FW2,'/GaitParamsSelectedBySpeed']);
load([path_Gait_FW2,'/SymetryIndex']);
load([path_Gait_FW2,'/walking_params_new']);
load metrics_perf 
...
analysis_struct_PA_FW3=load(['./Analysis_database/',PA_FW3,'.mat']);
path_PA_FW3=analysis_struct_PA_FW3.path_destination;

load([path_PA_FW3,'/PercentBarcodeStates']);
load([path_PA_FW3,'/PercentPostures']);
load([path_PA_FW3,'/DurationPeriodPostures']);

analysis_struct_Gait_FW3=load(['./Analysis_database/',Gait_FW3,'.mat']);
path_Gait_FW3=analysis_struct_Gait_FW3.path_destination;
load([path_Gait_FW3,'/GaitParamsSelectedBySpeed']);
load([path_Gait_FW3,'/SymetryIndex']);
load([path_Gait_FW3,'/walking_params_new']);
load metrics_perf 
...
oldfolder=cd(['./Application_folder/',Patient_ID]);
mkdir('Multi_test_Report')
cd('Multi_test_Report')
...
save('TablePAMetrics_allTests','DataCell')
...
'20', num2str(MPAS_controls(20)),num2str(SDPAS_controls(20)),num2str(PerBarc_1(20)),num2str(PerBarc_2(20)),num2str(PerBarc_3(20)),num2str(PerBarc_4(20))};
 save('TablePercentBarcodeStates_allTests','DataCell')
[NoRows,NoCols]=size(DataCell);          
%create table with data from DataCell
WordCreateTable(ActXWord,NoRows,NoCols,DataCell,1);%enter before table
CloseWord(ActXWord,WordHandle,FileSpec);   
