function Report_PA_Gait_Analysis
% -----------------------------------------------------------

% Number of the run
N=1;
h(N) = openfig('cad_report.fig','new');
% get handle to axes of figure
ax(N)=gca;
N=N+1;
h(N) = openfig('speed_report.fig','new');
% get handle to axes of figure
ax(N)=gca;
N=N+1;
h(N) = openfig('DS_report.fig','new');
% get handle to axes of figure
ax(N)=gca;
N=N+1;
h(N) = openfig('shank_angle_report.fig','new');
% get handle to axes of figure
ax(N)=gca;
N=N+1;
h(N) = openfig('knee_angle_report.fig','new');
% get handle to axes of figure
ax(N)=gca;
N=N+1;
h(N) = openfig('thigh_angle_report.fig','new');
% get handle to axes of figure
ax(N)=gca;
...
[ax5,h5]=suplabel('Shank-derived gait parameters','t');
...
% Number of the run
N=1;
h(N) = openfig('RMS_ml_report.fig','new');
% get handle to axes of figure
ax(N)=gca;
N=N+1;
h(N) = openfig('RMS_tot_report.fig','new');
% get handle to axes of figure
ax(N)=gca;
N=N+1;
h(N) = openfig('HR_ml_report.fig','new');
% get handle to axes of figure
ax(N)=gca;
N=N+1;
h(N) = openfig('HR_v_report.fig','new');
% get handle to axes of figure
ax(N)=gca;
