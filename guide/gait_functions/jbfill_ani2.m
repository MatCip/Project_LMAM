function[fillhandle,msg]=jbfill_ani(xpoints,upper,lower,color,edge,add,transparency)
...
%     grid on
%     legend('Datr')
if nargin<7;transparency=.2;end %default is to have a transparency of .5
