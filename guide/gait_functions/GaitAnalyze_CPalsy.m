function res = GaitAnalyze_CPalsy(ss, L1, L2,path_out)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function Cycle = CalcCycles(path_out)
global shanks;
[HsR,ToR] = DetectHsTo(shanks(:,1));
[HsL,ToL] = DetectHsTo(shanks(:,2));


%PlotHsTo(ToR, HsR, ToL, HsL,path_out);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% function PlotHsTo(ToR, HsR, ToL, HsL,path_out)
% global shanks;
% 
% path_1=strcat(path_out,'/Peak');
% disp(path_1);
% 
% 
% 
% figure_peak=figure;
% set(figure_peak, 'Visible', 'off');
% 
